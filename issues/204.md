...
Perform extensive research of heuristics, tests, common problems that affect DNS configs. I already have two: 
...
As your report, write an extensive technical spec for implementing this.
</TASK>